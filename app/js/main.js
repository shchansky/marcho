$(function () {
  ...
  $('.shop__filter-btn'). on ('click', function(){ //на этапе адаптива
  ...
  $('.button-list').on('click', function() {
    ...
    $('.shop-content__inner').addClass ('shop-content__nogrid') //на этапе адаптива
  });


  $('.button-grid').on('click', function() {
    $('.product-item').removeClass('product-item--list');
    $('.shop-content__inner').removeClass ('shop-content__nogrid') //на этапе адаптива
  });
